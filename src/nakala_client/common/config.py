...
class NakalaConfig:
    ...
    valid_group_ids: list = field(default_factory=lambda: ['de0f2a9b-a198-48a4-8074-db5120187a16'])
    ...
    def __post_init__(self):
        ...
        if not self.api_key:
            raise ValueError("API key must be provided either in config or NAKALA_API_KEY environment variable")
