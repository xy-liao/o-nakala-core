...
- **[Getting Started with NAKALA](https://documentation.huma-num.fr/nakala/)** - Official workflow introduction
- **[Data Preparation Guide](https://documentation.huma-num.fr/nakala-preparer-ses-donnees/)** - Prepare your research data properly

### **Detailed Processes**
- **[Data Deposit Process](https://documentation.huma-num.fr/nakala/)** - Official deposit process
- **[Collection Management](https://documentation.huma-num.fr/nakala/)** - Official collection workflow
...
- **[NAKALA Test Platform](https://test.nakala.fr)** - Safe environment for testing workflows (test accounts available)
