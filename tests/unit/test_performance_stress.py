...
class TestPerformanceMetrics:
    ...
    def test_file_validation_performance(self, performance_config):
        ...
        for size_bytes in file_sizes:
            ...
            try:
                ...
                assert validation_time < 1.0, f"Validation too slow for {size_bytes} bytes: {validation_time}s"
    ...
    def test_metadata_preparation_performance(self, performance_config):
        ...
        assert preparation_time < 0.1, f"Metadata preparation too slow: {preparation_time}s"
    ...
    def test_csv_parsing_performance(self, performance_config):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(csv_path, 'w', newline='', encoding='utf-8') as f:
                writer = csv.writer(f)
                writer.writerow([
                    "file", "status", "type", "title", "author", "description", "keywords"
                ])
            ...
            assert validation_time < 5.0, f"CSV validation too slow for {num_entries} entries: {validation_time}s"
    ...
    def test_configuration_performance(self, performance_config):
        ...
        assert config_creation_time < 1.0, f"Config creation too slow: {config_creation_time}s for 100 configs"
...
class TestStressScenarios:
    ...
    def test_large_file_stress(self, stress_config):
        ...
        try:
            ...
            assert validation_time < 10.0, f"Large file validation too slow: {validation_time}s"
    ...
    def test_memory_stress_multiple_files(self, stress_config):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert total_time < 30.0, f"Multiple file validation too slow: {total_time}s"
    ...
    def test_rapid_successive_operations(self, stress_config):
        ...
        try:
            ...
            assert avg_time_per_op < 0.1, f"Operations slowing down: {avg_time_per_op}s per operation"
...
class TestMemoryManagement:
    ...
    def test_memory_usage_file_processing(self, memory_config):
        ...
        assert memory_increase < max_acceptable_increase, f"Excessive memory usage: {memory_increase} bytes"
    ...
    def test_client_cleanup(self, memory_config):
        ...
        assert memory_increase < max_acceptable_increase, f"Potential memory leak: {memory_increase} bytes"
    ...
    def test_large_metadata_memory_efficiency(self, memory_config):
        ...
        large_metadata = {
            ...
            "description": "fr:" + "Long description " * 2000 + "|en:" + "Long description " * 2000,
            "keywords": "fr:" + ";".join([f"keyword{i}" for i in range(1000)]) + "|en:" + ";".join([f"keyword{i}" for i in range(1000)]),
            "type": "http://purl.org/coar/resource_type/c_ddb1"
        }
        ...
        assert processing_increase < 100 * 1024 * 1024, f"Large metadata processing too memory-intensive: {processing_increase} bytes"
    ...
    def test_timeout_handling_under_load(self, resource_config):
        ...
        with ThreadPoolExecutor(max_workers=2) as executor:
            ...
            with tempfile.NamedTemporaryFile() as f:
                ...
                assert operation_time < 5.0, f"Operation too slow under load: {operation_time}s"
