...
class TestNakalaUploadClient:
    ...
    def test_create_dataset_success(self, upload_client):
        ...
        with patch.object(upload_client.session, 'post', return_value=mock_response) as mock_post:
            metadata = [
                {
...
class TestUploadIntegration:
    ...
    def test_file_processing_workflow(self):
        ...
        test_files = []
        for i in range(3):
            with tempfile.NamedTemporaryFile(mode='w', delete=False, suffix=f'_test_{i}.txt') as tmp:
