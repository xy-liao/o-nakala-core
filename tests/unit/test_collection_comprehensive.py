...
class TestNakalaCollectionClient:
    ...
    def test_validate_collection_config_missing_data_ids(self, collection_client):
        ...
        with pytest.raises(NakalaValidationError, match="Either 'data_ids' or 'upload_data' must be provided"):
            collection_client._validate_collection_config(config)
    ...
    def test_create_collection_success(self, collection_client):
        ...
        with patch.object(collection_client.session, 'post', return_value=mock_response) as mock_post:
            metadata = [
                {
    ...
    def test_create_collection_api_error(self, collection_client):
        ...
        with patch.object(collection_client.session, 'post', return_value=mock_response):
...
Dataset 4,data-4,failed,Research Collection"""
    ...
    def test_group_data_by_collection(self, collection_client):
        ...
        upload_data = [
            {"identifier": "data-1", "title": "Dataset 1", "collection": "Research Collection"},
            {"identifier": "data-2", "title": "Dataset 2", "collection": "Research Collection"},
            {"identifier": "data-3", "title": "Dataset 3", "collection": "Archive Collection"},
            {"identifier": "data-4", "title": "Dataset 4", "collection": "Research Collection"},
            {"identifier": "data-5", "title": "Dataset 5", "collection": "Archive Collection"},
        ]
    ...
    def test_group_data_by_collection_missing_collection_field(self, collection_client):
        ...
        upload_data = [
            ...
            {"identifier": "data-2", "title": "Dataset 2", "collection": "Test Collection"},
        ]
...
Dataset 5,data-5,success,Teaching Collection"""
    ...
    def test_batch_collection_creation(self):
        ...
        grouped_data = {
            ...
            "Archive Collection": [
                {"identifier": "data-3", "title": "Dataset 3"}
            ]
        }
