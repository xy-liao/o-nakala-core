...
class TestParameterizedFileTypes:
    ...
    @pytest.mark.parametrize("language_code,sample_text", [
        ("fr", "Titre français"),
        ("en", "English title"),
        ("de", "Deutscher Titel"),
        ("es", "Título español"),
    ...
    def test_multilingual_metadata_processing(self, base_config, language_code, sample_text):
    ...
    @pytest.mark.parametrize("metadata_combination", [
        {
    ...
    def test_metadata_combinations(self, base_config, metadata_combination):
        ...
        prepared_metadata = upload_client.prepare_metadata_from_dict(metadata_combination)
        ...
        # Check type entry
        type_entries = [m for m in prepared_metadata if 'type' in m.get('propertyUri', '')]
...
class TestNegativeScenarios:
    ...
    @pytest.mark.parametrize("malformed_multilingual", [
        "no-colon-separator",
        ":empty-language",
        "lang:",  # Empty value
...
class TestCollectionParameterized:
    ...
    def test_collection_metadata_variations(self, collection_config, collection_metadata):
    ...
    @pytest.mark.parametrize("data_ids_format", [
