...
class TestNakalaAPIIntegration:
    ...
    def api_config(self):
        ...
        api_key = os.getenv('NAKALA_TEST_API_KEY', '33170cfe-f53c-550b-5fb6-4814ce981293')
...
class TestWorkflowPerformance:
    ...
    def test_metadata_processing_performance(self, performance_config):
        ...
        assert processing_time < 1.0, f"Metadata processing too slow: {processing_time:.2f}s for 100 iterations"
    ...
    def test_workflow_documentation_consistency(self):
        ...
        for doc_file in doc_files:
            ...
            if doc_path.exists():
                ...
                assert doc_path.stat().st_size > 0, f"Empty documentation file: {doc_file}"
